...
import '../providers/length_provider.dart';
...
class _LengthScreenState extends ConsumerState<LengthScreen> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(lengthProvider);
    final notifier = ref.read(lengthProvider.notifier);

    return Scaffold(
      extendBodyBehindAppBar: true,
      appBar: const GlassAppBar(title: 'Length Converter'),
                      ...
                      onChanged: (val) {
                        ...
                        if (value != null) {
                          ...
                          ref.read(historyProvider.notifier).addEntry(
                                'Length: ${state.fromUnit.symbol} to ${state.toUnit.symbol}',
                    ...
                    Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Icon(LucideIcons.arrowRightLeft, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.12)),
                        ),
                        Expanded(
                          child: _UnitDropdown(
                            label: 'To Unit',
              ...
              GlassPane(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      'Lengths are fundamental measurements. The Meter is the base unit of length in the International System of Units (SI). All other units here are calculated using high-precision constants relative to the meter.',
